...
/* la tabla de informacion contiene informacion de productos*/
...
create table chemas.producto (
  ...
  foreign key fk_producto_caregoria (id_informacion) references informacion(id_informacion)  
)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
INSERT INTO chemas.usuario (id_usuario, username,password,nombre, apellidos, correo, telefono,ruta_imagen,activo) VALUES 
...
/*Se insertan 3 informacion de productos como ejemplo */
INSERT INTO chemas.informacion (id_informacion,descripcion,ruta_imagen,activo) VALUES 
('1','Monitores', true), 
('2','Teclados', true),
('3','Tarjeta Madre',true),
('4','Celulares', false);

/*Se insertan 4 productos por informacion */
INSERT INTO chemas.producto (id_producto,id_informacion,descripcion,detalle,precio,existencias,ruta_imagen,activo) VALUES
...
INSERT INTO chemas.factura (id_factura,id_usuario,fecha,total,estado) VALUES
...
INSERT INTO chemas.venta (id_venta,id_factura,id_producto,precio,cantidad) values
(1,1,5,45000,3),
(2,1,9,15780,2),
(3,1,10,15000,3),
(4,2,5,45000,1),
...
insert into chemas.rol (id_rol, nombre, id_usuario) values
